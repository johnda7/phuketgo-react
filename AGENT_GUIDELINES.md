...
## 📱 **ЭТАП 3: TELEGRAM MINI APP (СЛЕДУЮЩИЙ)**
...
#### **3.1. Настроить Telegram Mini App**
```yaml
...
Действия:
  ...
  - Команда: /newapp
  - Выбрать: @phuketgobot
  - Название: PhuketGo - Лучшие туры
  - Описание: 🏝️ Экскурсии по Пхукету
  - URL: https://johnda7.github.io/phuketgo-react/
  - Загрузить иконку (красивая фотка острова)
  - Команда: /setmenubuttonurl
...
```yaml
Задача: Подключить Telegram SDK
Время: 30 минут
Действия:
